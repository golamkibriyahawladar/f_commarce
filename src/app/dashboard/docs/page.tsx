    ...
    <div className="p-6 max-w-6xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-sm text-zinc-500 mt-1">Configure webhooks, access system APIs, and understand core platform integrations.</p>
        </div>
      </div>

      {/* Grid: Nav Sidebar & Main Content */}
          ...
          {activeTab === 'webhooks' && (
            <div className="bg-white rounded-2xl border border-zinc-200 p-6 sm:p-8 shadow-sm space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-zinc-950 rounded-xl p-4 font-mono text-xs text-zinc-300 relative overflow-hidden">
                  <button 
    ...
    "created_at": "2026-06-25T00:49:59.000Z"
              ...
              <div className="space-y-4 pt-4 border-t border-zinc-100">
                ...
                <div className="space-y-2">
                  ...
                  <div className="bg-zinc-950 rounded-xl p-4 font-mono text-xs text-zinc-300 max-h-72 overflow-y-auto">
            ...
            <div className="bg-white rounded-2xl border border-zinc-200 p-6 sm:p-8 shadow-sm space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <div className="bg-zinc-950 rounded-xl p-4 font-mono text-xs text-zinc-300 relative">
                    <button 
                      onClick={() => copyToClipboard(JSON.stringify({
...
{`{
  ...
  "content": "Hello! Your package has..."
                ...
                <div className="space-y-2">
                  ...
                  <div className="bg-zinc-950 rounded-xl p-4 font-mono text-xs text-zinc-300">
                    <pre className="text-[10px] leading-relaxed">
{`{
  "success": true,
  "message": {
    ...
    "created_at": "2026-06-25T00:52:12.339Z"
          ...
          {/* Tab Content: Signature Security */}
          {activeTab === 'security' && (
            <div className="bg-white rounded-2xl border border-zinc-200 p-6 sm:p-8 shadow-sm space-y-6">
              <div>
