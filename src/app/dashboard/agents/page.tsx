    ...
    <div className="p-6 max-w-6xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {deleteModalOpen && agentToDelete && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/45 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white w-full max-w-sm rounded-2xl border border-zinc-200 shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col">
            ...
            <div className="p-6 text-center space-y-4">
              ...
              <div className="space-y-1.5">
                <h3 className="text-base font-bold text-zinc-900">Delete AI Agent</h3>
                <p className="text-xs text-zinc-505 leading-relaxed">
                  Are you sure you want to delete <strong className="text-zinc-800">'{agentToDelete.credentials?.name || 'this AI Agent'}'</strong>? This action is permanent and cannot be undone.
                </p>
              </div>
            </div>

            {/* Modal Footer */}
            <div className="p-4.5 border-t border-zinc-150 flex gap-3 bg-zinc-50/50">
              <button 
                type="button" 
                onClick={() => {
                  setDeleteModalOpen(false);
              ...
              <button 
                ...
                disabled={deleting}
                className="flex-1 py-2 px-4 bg-red-600 hover:bg-red-750 text-xs font-bold text-white rounded-lg transition-colors flex items-center justify-center gap-2 shadow-md hover:shadow-red-600/10 cursor-pointer active:scale-95 duration-150"
              >
